          ...
          <View style={[{ height: hp(100) }, tailwind('bg-brand') ]}>
            <SafeAreaView style={[tailwind('flex  justify-center  z-50 '), { height: hp(100) }]}>
                ...
                <View style={[{ paddingHorizontal: wp(5), paddingVertical: hp(5) }]}>
                  <Text style={[tailwind('text-white text-5xl font-black'), { fontFamily: 'Caveat'}]}>
                    Algoritma Alam.
                  </Text>
                  ...
                  <TypeWriter typing={1} maxDelay={18} fixed={true} style={[tailwind('text-white text-2xl  mt-3'), { fontFamily: 'Caveat' }]}>
                ...
                <View style={[{ paddingHorizontal: wp(5), paddingBottom: hp(10) }]}>
                  <Text style={[tailwind('text-white text-xl font-light'), { fontFamily: 'Caveat'}]}>@algoritma_alam</Text>
              ...
              <LinearGradient
                ...
                style={[tailwind('absolute top-0  left-0 right-0 h-full w-full'), { height: hp(100) }]}>
                    <SafeAreaView style={[tailwind(' w-full  flex  h-full justify-start  z-50 mt-11'), { height: hp(100), paddingHorizontal: wp(5), paddingVertical: hp(10) }]}>
                        ...
                        <View style={[{ paddingHorizontal: wp(5), paddingBottom: hp(16) }, tailwind('absolute bottom-0 flex flex-row items-center justify-between  w-full')]}>
                          <ArrowDown style={[tailwind('w-5 h-8 text-white mx-2 opacity-70')]}/>
                        </View>
